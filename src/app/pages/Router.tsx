...
import { AppSearchScreen } from '../features/app-search';
...
import { DeviceVerificationPrompt } from '../components/DeviceVerificationPrompt';
...
import { CreatePostModalRenderer } from '../features/create-post';
    ...
    <Route>
      ...
      >
        ...
        >
          ...
          <Route path={_FEED_PATH} element={<HomeFeed />} />
          <Route
            path={_ROOM_PATH}
            element={
        ...
        <Route path={APP_PATH} element={<AppShell />}>
          ...
          <Route path={_APP_SEARCH_PATH} element={<AppSearchScreen />} />
          <Route
