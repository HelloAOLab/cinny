...
export const HOME_FEED_PATH = `/home/${_FEED_PATH}`;
...
export const _APP_CHAT_PATH = 'chat/';
export const _APP_CHAT_ROOM_PATH = 'chat/:roomIdOrAlias/:eventId?/';
...
export const _APP_POST_PATH = 'post/:eventId/';
export const APP_COMMUNITY_POST_PATH = `/app/:communityIdOrAlias/${_APP_POST_PATH}`;
...
export const _APP_INBOX_PATH = 'inbox/';
export const APP_INBOX_PATH = `/app/${_APP_INBOX_PATH}`;
export const APP_COMMUNITY_INBOX_PATH = `/app/:communityIdOrAlias/${_APP_INBOX_PATH}`;
export const _APP_SEARCH_PATH = 'search/';
export const APP_SEARCH_PATH = `/app/${_APP_SEARCH_PATH}`;
export const APP_COMMUNITY_SEARCH_PATH = `/app/:communityIdOrAlias/${_APP_SEARCH_PATH}`;
